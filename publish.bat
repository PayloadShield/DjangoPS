@echo off
REM DjangoPS Payload Shield - PyPI Publishing Script
REM This script builds and publishes the package to PyPI
REM GitHub: https://github.com/PayloadShield/DjangoPS
REM
...
echo.
echo ========================================
echo DjangoPS Payload Shield - PyPI Publisher
echo ========================================
echo.
...
echo ========================================
python -c "import re; content = open('pyproject.toml').read(); name = re.search(r'name = \"([^\"]+)\"', content); version = re.search(r'version = \"([^\"]+)\"', content); print(f'  Name:    {name.group(1)}') if name else None; print(f'  Version: {version.group(1)}') if version else None; print(f'  Repo:    https://github.com/PayloadShield/DjangoPS')"
echo ========================================
echo.
...
echo ========================================
echo.
echo   View:    https://pypi.org/project/django-payloadshield/
echo   Install: pip install django-payloadshield
echo   GitHub:  https://github.com/PayloadShield/DjangoPS
echo.
